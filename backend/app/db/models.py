...
class Base(DeclarativeBase):
    """ฐานของโมเดลฐานข้อมูลสำหรับ FR-BKG-01, FR-BKG-02, FR-BKG-04"""


class Slot(Base):
    """โมเดลช่วงเวลาตรวจสำหรับ FR-BKG-01 และ FR-BKG-06"""
...
class Booking(Base):
    """โมเดลการจองที่อ้างอิง HN สำหรับ FR-BKG-02, FR-BKG-04 และ IF-HIS-01"""
...
class AuditLog(Base):
    """โมเดล audit log สำหรับ DOM-PDPA-01"""
